...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_section_social).toUpperCase(l);
                case 1:
                    return getString(R.string.title_section_drive).toUpperCase(l);
                case 2:
                    return getString(R.string.title_section_charts).toUpperCase(l);
            }
            return null;
        }
